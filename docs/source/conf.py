...
# corradin_opioid_project documentation build
...
from corradin_opioid_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "corradin_opioid_project"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "corradin_opioid_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "corradin_opioid_project.tex",
        "corradin_opioid_project Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "corradin_opioid_project",
        "Project corradin_opioid_project codebase.",
        "Data-Science",
    )
]
